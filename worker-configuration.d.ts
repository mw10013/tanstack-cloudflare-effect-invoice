/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 40f3ef086f72bfaba1d20f7e915fa86e)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		ORGANIZATION_AGENT: DurableObjectNamespace<import("./src/worker").OrganizationAgent>;
		INVOICE_EXTRACTION_WORKFLOW: Workflow<Parameters<import("./src/worker").InvoiceExtractionWorkflow['run']>[0]['payload']>;
		GEMINI_INVOICE_EXTRACTION_WORKFLOW?: Workflow<Parameters<import("./src/worker").GeminiInvoiceExtractionWorkflow['run']>[0]['payload']>;
	}
}
